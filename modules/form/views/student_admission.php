                        ...
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="form-group mb-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    ?>
                                    <select class="form-control admission-center" name="center_id" id="center_id" data-control="select2"
                                ...
                                <div class="form-group mb-4 col-lg-4 col-xs-12 col-sm-12">
                                    ...
                                    <select class="form-control admission-course" name="course_id" data-control="select2"
