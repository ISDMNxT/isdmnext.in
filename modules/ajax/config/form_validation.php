...
$config = array(
    ...
    'add_franchise_form' => array(
        ...
        array(
            'label' => 'Master Franchise Name',
            'field' => 'institute_name',
            'rules' => 'is_unique[centers.institute_name]',
            'errors' => [
                'is_unique' => 'This %s is already exists.'
            ]
        )
    ),
    'add_staff_form' => array(
        array(
            'field' => 'email_id',
            'label' => 'Email',
            'rules' => 'is_unique[centers.email]',
    ...
    'update_employer' => array(
        ...
        array(
            'label' => 'Designation of employer head',
