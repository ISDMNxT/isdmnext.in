                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                            <a href="#" class="d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2">
                                <i class="ki-outline ki-profile-circle fs-4 me-1"></i> Employer
                            </a>
                            <a href="#" class="d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2">
                            ...
                            <a href="#" class="d-flex align-items-center text-gray-500 text-hover-primary mb-2">
                                &nbsp; &#127760; <span class="student-website">{website}</span>
                            </a>
                        </div>
                        <!--end::Info-->
                    </div>
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="fs-2 fw-bold" data-kt-countup="true"
                                        data-kt-countup-value="{ttl_job_post}">0</div>
                                </div>
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-semibold fs-6 text-gray-500 align-items-center flex-wrap w-100">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="fs-2 fw-bold me-5" data-kt-countup="true"
                                        data-kt-countup-value="{ttl_hired}">0</div>
                                </div>
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-semibold fs-6 text-gray-500 align-items-center flex-wrap w-100">
...
if (file_exists(__DIR__ . '/panel/' . $tab . EXT)) {
    echo $this->parser->parse('employer/panel/' . $tab, $center_details, true);
}
?>
<!--end::details View-->