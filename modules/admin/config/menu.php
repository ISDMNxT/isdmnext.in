            ...
            array(
                ...
                'submenu' => array(
                    array(
                        ...
                        'type' => 'manage_packages',
                        'icon' => array('file', 2),
                        'url' => 'employer/manage-packages',
                    ),
                    array(
                        'label' => 'Packages List',
                        'type' => 'packages_list',
                        'icon' => array('file', 2),
                        'url' => 'employer/packages-list',
                    ),
                    array(
                        'label' => 'Manage Group',
                        'type' => 'manage_group',
                        'icon' => array('file', 2),
                        'url' => 'employer/manage-group',
                    ),
                    array(
                        'label' => 'Manage Industry',
                        'type' => 'manage_industry',
                        'icon' => array('file', 2),
                        'url' => 'employer/manage-industry',
                    ),
                    array(
                        'label' => 'Mapping Group Industry',
                        'type' => 'mapping_group_industry',
                        'icon' => array('file', 2),
                        'url' => 'employer/mapping-group-industry',
                    ),
                    array(
                        'label' => 'Manage Department',
                        'type' => 'manage_department',
                        'icon' => array('file', 2),
                        'url' => 'employer/manage-department',
                    ),
                    array(
                        'label' => 'Manage Role',
                        'type' => 'job_role',
                        'icon' => array('file', 2),
                        'url' => 'employer/job-role',
                    ),
                    array(
                        'label' => 'Mapping Department Role',
                        'type' => 'mapping_department_role',
                        'icon' => array('file', 2),
                        'url' => 'employer/mapping-department-role',
                    ),
                    array(
                        'label' => 'Manage Skill',
                        'type' => 'job_skill',
                    ...
                    array(
                        'label' => 'Mapping Role Skill',
                        'type' => 'mapping_role_skill',
                        'icon' => array('file', 2),
                        'url' => 'employer/mapping-role-skill',
                    ),
                    array(
                        'label' => 'Employers',
                        'icon' => array('people', 5),
...
$all_permission['job_board'] = array(
        'label' => 'Job Board',
                'type' => 'job_board',
                'icon' => array('briefcase', 4),
                'submenu' => array(
                    array(
                        'label' => 'Job Request Report',
                        'icon' => array('briefcase', 5),
                        'type' => 'job_request_report',
                        'url' => 'employer/job_request_report',
                    )
                )
    );
if($loginTypes['admin_type'] == 'center' && empty($loginTypes['staff_id'])){
    ...
    $config['dashboard']['menu'][] = $all_permission['job_board'];
...
if($loginTypes['admin_type'] == 'employer'){
    $config['dashboard']['menu'][] = array(
                'label' => 'Dashboard', 
                'type' => 'dashboard', 
                'url' => 'employer/index'
