                ...
                <div id="kt_app_sidebar" class="app-sidebar  flex-column " data-kt-drawer="true"
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        ...
                        <a href="{base_url}admin" class="fs-1">
                            ...
                            if($this->session->userdata('admin_type') == 'master_franchise'){
                                $aaTypeN = 'master Franchise';
                            }
...
<script>
    ...
    const is_staff_login = '<?php if(!empty($this->session->userdata('staff_id'))){ echo 'Y'; } else { echo 'N'; } ?>';
    const all_templates = '';
