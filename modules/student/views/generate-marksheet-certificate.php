        ...
        <form id="create-marksheet">
            <div class="{card_class}">
                <div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse"
                    ...
                    <h3 class="card-title">Generate Marksheet & Certificate</h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="student_id" id="student_id" data-control="select2" data-placeholder="Select Student"
                                    class="form-select">
                                    <option></option>
                                    ?>
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="duration" id="duration" class="form-select" data-control="select2"
                            ...
                            <div class="col-md-4 form-group mb-5">
                                <label for="" class="form-label required">Select Exam</label>
                                <select name="exam_id" id="exam_id" class="form-select" data-control="select2"
                        ...
                        <input type="hidden" name="admit_card_id" id="admit_card_id" value="">
                    </div>
