                    ...
                    <div class="card-toolbar">
                        <?php if($this->center_model->isCenter()) { ?>
                            <?php if(!empty($change_details['id'])) { ?>
                                ...
                                <a class="btn btn-info btn-xs btn-sm student_request" data-id="{student_id}" >Send Request To Change Student Details</a>
                                <?php } ?>
                            <?php } else { ?>
                                <a class="btn btn-info btn-xs btn-sm student_request" data-id="{student_id}" >Send Request To Change Student Details</a>
                            <?php } ?>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group mb-4 col-lg-6 col-xs-12 col-sm-12">
                            ...
                            <div class="input-group">
                                <input type="number" name="alternative_mobile" class="form-control" placeholder="Mobile"
