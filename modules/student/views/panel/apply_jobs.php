...
<?php
  $job_list = $this->db->select('j.*,c.institute_name as center_name,i.industry,e.qualification,jr.role,state.STATE_NAME,district.DISTRICT_NAME,c.logo,ei.about_company, ei.website,rir.id as rir, DATE_FORMAT(rir.created_at,"%d-%m-%Y") as applied_date,rir.status as rstatus')
                    ->from('jobs as j')
