        ...
        <div class="{card_class}">
            ...
            <div class="card-body p-0">
                <table class="table table-striped table-hover table-bordered mb-0" data-id="{student_id}">
                    ...
                    <tbody>
                        <?php if ($this->center_model->isAdminOrCenter()) { ?>
                        <tr>
                        ...
                        <?php } else { ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <label class="btn btn-active-info btn-sm border-info border border-1" for="resume">
                                            <input type="file" name="resume" class="d-none upload-student-docs"
                                                accept=".pdf,.doc" id="resume">
                                            <i class="fa fa-cloud-upload"></i>
                                            Change
                                        </label>
                                                
                                        <?php
                                        if (file_exists('upload/' . $resume) && $resume) { ?>
                                            <a href="{base_url}upload/{resume}" target="_blank"
                                                class="btn btn-sm btn-active-primary border-primary border border-1">
                                                <i class="fa fa-eye"></i>
                                                View
                                            </a>
                                            ...
                                            echo badge('Resume Not Found.', 'danger');
                                        }
                                        ?>
                                    </div>
                                </td>
