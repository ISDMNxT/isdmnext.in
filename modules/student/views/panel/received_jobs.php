...
<div class="job-container">
  ...
  <div class="job-card">
      <div class="job-details">
          ...
          <?php if($value['student_status'] == 'pending') { ?>
          <a data-param='<?php echo json_encode(['id' => $value['sir_id'], 'center_status' => 'approved', 'student_status' => 'approved']); ?>' data-type="Accept" class="apply-button" style="cursor: pointer;" >Accept</a>&nbsp;<a class="reject-button" style="cursor: pointer;" data-param='<?php echo json_encode(['id' => $value['sir_id'], 'center_status' => 'rejected', 'student_status' => 'rejected']); ?>' data-type="Reject" >Reject</a>
          <?php } else { ?>
          <?php if($value['student_status'] == 'approved') { ?>
            <a class="apply-button">Accepted</a>
          <?php } ?>
          <?php if($value['student_status'] == 'rejected') { ?>
            <a class="reject-button">Rejected</a>
          <?php } ?>
          <?php } ?>
      </div>
