    ...
    <div class="col-md-4">
        <div class="card border-dark">
            <div class="card-header">
                <h3 class="card-title">List All Courses
                </h3>
                <h3 class="card-title">Select All Courses&nbsp;
                    <input class="form-check-input assign-to-all" type="checkbox" value="aa" id="flexSwitchDefault" />
                </h3>
            </div>
                    ...
                    foreach ($all_courses as $row) {
                        ...
                        <label class="d-flex flex-stack cursor-pointer mb-5">
                            ...
                            <div class="form-check form-switch form-check-custom form-check-solid">
                                ...
                                $amount = $chk->num_rows() ? $row['fees'] : $row['fees'];
