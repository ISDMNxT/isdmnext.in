                ...
                <table class="table table-bordered border-primary">
                    ...
                    <tbody>
                                        ...
                                        <td class="text-center fs-4">{title}</td>
                                         ...
                                         <td>
                                            <div class="form-group">
                                                <input type="text" placeholder="Enter {title} Marks" name="marks[{id}][{name}]" class="form-control custom_setting_input cal-marks" value="{tmarks}">
                                            </div>
                                         </td>';
                        ...
                        foreach ($subjects as $subject) {
                            ...
                            <tr>
                                ...
                                if ($subject['subject_type'] == 'both' or $subject['subject_type'] == 'theory') {
                                    ...
                                    $sttl += $marks[$subject['subject_id']]['theory_marks'];
                                    echo $this->parser->parse_string($template, [
                                        'id' => $subject['id'],
                                        'title' => 'Theory',
                                        'name' => 'theory_marks',
                                        'tmarks' => $marks[$subject['subject_id']]['theory_marks'],
                                ...
                                if ($subject['subject_type'] == 'practical') {
                                    ...
                                    $sttl += $marks[$subject['subject_id']]['practical'];

                                    echo $this->parser->parse_string($template, [
                                        'id' => $subject['id'],
                                        'title' => 'Practical',
                                        'name' => 'practical',
                                        'tmarks' => $marks[$subject['subject_id']]['practical'],
                        ...
                        <tr class="bg-light-success text-white">
                            ...
                            <th class="total-marks text-center fs-4"><?= $sttl ?></th>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<input type="hidden" name="ttl_marks" class="ttl-marks" value="<?=$sttl?>">
