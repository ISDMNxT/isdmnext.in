                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group set-duration">
                                    ...
                                    <select name="duration" data-placeholder="Select duration"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="subject_name" name="subject_name" value="">
                                    <select name="subject_id" data-control="select2" data-placeholder="Select Subject"
                                        id="subject_id" class="form-select fetch-subject">
                                        <option></option>
                                        <?php
                                        $listSubject = $this->db->where('isDeleted', 0)->get('subject_master');
                                        foreach ($listSubject->result() as $s)
                                            echo "<option value='$s->id' data-subject='$s->subject_name' data-code='$s->subject_code' >$s->subject_name</option>";
                                        ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly="true" class="form-control" placeholder="Subject Code"
    ...
    <div class="col-md-12 mt-4">
        <div class="{card_class}">
            ...
            <div class="form-group col-md-3 mt-4" style="margin-left: 25px;margin-bottom: -25px;" >
                <label class="form-label required">Search Course</label>
                <select name="courseSearch" data-control="select2"
                    data-placeholder="Select Course" class="form-control courseSearch">
...
<script id="formTemplate" type="text/x-handlebars-template">
    ...
    <div class="form-group mb-4">
        <label class="form-label" id="subject_name_lable" >Subject Name - {{subject_name}}</label>
        <label class="form-label" id="subject_code_lable">Subject Code - {{subject_code}}</label>
    </div>
    <div class="form-group mb-4">
        <label class="form-label required">Subject Name</label>
        <input type="hidden" name="course_id" value="{{course_id}}">
        <input type="hidden" id="subject_id_temp" name="subject_id" value="{{subject_id}}">
        <input type="hidden" id="subject_name_temp" name="subject_name" value="{{subject_name}}">
        <input type="hidden" id="subject_code_temp" name="subject_code" value="{{subject_code}}">
        
        <select data-control="select2" data-placeholder="Select Subject"
            class="form-select fetch-subject-temp">
            <option></option>
            <?php
            $listSubject = $this->db->where('isDeleted', 0)->get('subject_master');
            foreach ($listSubject->result() as $s){
                $select = "";
                echo "<option value='$s->id' data-subject='$s->subject_name' data-code='$s->subject_code' $select >$s->subject_name</option>";
            }
            ?>
        </select>
    </div>
