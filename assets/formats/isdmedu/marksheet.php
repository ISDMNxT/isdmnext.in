...
<body class="position-relative">
    ...
    <p class="position-absolute" style="top:29%;left:25.5%">{student_name}</p>
    <p class="position-absolute" style="top:31.1%;left:19%">{father_name}</p>
    <!-- <p class="position-absolute " style="top:33.2%;left:26.5%">{mother_name}</p> -->
    <p class="position-absolute " style="top:33.2%;left:14.2%">{course_name}</p>
    <p class="position-absolute text-capitlize" style="top:35.3%;left:16%">{duration} {duration_type}</p>
    
    <p class="position-absolute text-capitlize" style="top:35.3%;left:37.6%">{from_date} </p>
    <p class="position-absolute text-capitlize" style="top:35.3%;left:57.6%">{to_date} </p>

    <p class="position-absolute " style="top:37.5%;left:25.5%">{center_name}</p>
    <p class="position-absolute " style="top:39.6%;left:21.5%">{enrollment_no}</p>
    <p class="position-absolute " style="top:39.6%;left:50.5%;width:150px">{roll_no}</p>
    ...
    <p class="position-absolute" style="bottom:20%;left:26.4%;font-size:15px">{percentage} %</p>
    <p class="position-absolute" style="bottom:20%;left:47.8%;font-size:15px">{session}</p>
    <p class="position-absolute" style="bottom:20.15%;left:77.8%;font-size:15px">{issue_date}</p>

    <div class="position-absolute" style="bottom:15.2%;left:76%;">
        <img src="upload/{c_signature}" style="width: 96px;height:70px;" alt="">
    </div>

    <div class="position-absolute" style="bottom:15.2%;left:13%;">
        <img src="upload/{admin_signature}" style="width: 96px;height:70px;" alt="">
    </div>
</body>
</html>
