document.addEventListener('DOMContentLoaded', function (e) {
    ...
    var list_url = 'course/list-subjects?course=';
                        ...
                        axios
                            ...
                            .then(function (e) {
                                ...
                                if (e.data.status) {
                                    add_form.reset(),
                                        Swal.fire({
                                            text: "Course And Subject Mapped Successfully.",
                                            icon: "success",
                                            buttonsStyling: !1,
    ...
    if (list_subjects) {
        ...
        var dt = list_subjects.DataTable({
            dom: small_dom,
            ajax: {
                url: ajax_url + list_url + courseSearch.val(),
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                                ...
                                <button class="btn btn-sm btn-light-danger delete-subject" data-id="${row.cc_id}">
    ...
    if (delete_list_subjects) {
        ...
        ddt.on('draw',function(r){
            delete_list_subjects.unDeleteEvent('subjects', 'Subject','id');
        })
    ...
    $(document).on('change', '.courseSearch', function () {
        list_url = 'course/list-subjects?course='+$(this).val();
        list_subjects.DataTable().ajax.url(ajax_url + list_url).load();
    });
