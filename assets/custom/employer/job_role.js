document.addEventListener('DOMContentLoaded', function (e) {
    const form          = document.getElementById('job_role');
    const list_url      = 'employer/list-role';
    const save_url      = 'employer/add-role';
    const delete_url    = 'employer/delete-role';
    ...
    if (table.length) {
        ...
        dt.on('draw', function (e) {
            EditForm(table,'employer/edit-role','Edit Role');
