document.addEventListener('DOMContentLoaded', function (e) {
    const form          = document.getElementById('job_group');
    const list_url      = 'employer/list-group';
    const save_url      = 'employer/add-group';
    const delete_url    = 'employer/delete-group';
    const table         = $('#list_job_group');
    ...
    if (table.length) {
        ...
        dt.on('draw', function (e) {
            EditForm(table,'employer/edit-group','Edit Group');
