document.addEventListener('DOMContentLoaded', function (e) {
    ...
    const list_url      = 'employer/list-department';
    const save_url      = 'employer/add-department';
    const delete_url    = 'employer/delete-department';
    const table         = $('#list_department_form');
    ...
    if (table.length) {
        ...
        dt.on('draw', function (e) {
            EditForm(table,'employer/edit-department','Edit Department');
