    ...
    center_select_box.select2({
        ...
        $.AryaAjax({
            ...
            assign_form_and_display_box.html(rr.html).find('#list-center-courses').DataTable({
                paging: true, // Dropdown for selecting records per page
                pageLength: 10, // Default number of records per page
                searching: false, // Enables search box
                ordering: false, // Enables column sorting
                info: false, // Shows "Showing X to Y of Z entries"
                dom: 'lfrtip' // Default layout with pagination controls
            });
            ...
            assign_form_and_display_box.find(".assign-to-all").change(function () {
                if ($(this).prop("checked")) {
                    Swal.fire({
                        title: 'Notice',
                        icon: 'warning',
                        html: 'Are you sure you want to add all courses from selected center',
                        showCancelButton: true,
                        confirmButtonText: 'ok',
                        cancelButtonText: 'Cancel',
                        allowOutsideClick: false,
